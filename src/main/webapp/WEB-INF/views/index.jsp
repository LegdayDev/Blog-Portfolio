		...
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="col-md-10 col-lg-8 col-xl-7">
				...
				<div class="post-preview">
					...
					<p class="post-meta">
						Posted by <a href="#!">Start Bootstrap</a> on September 18, 2022
					</p>
				</div>
				<!-- Divider-->
				<hr class="my-4" />
				...
				<div class="post-preview">
					...
					<p class="post-meta">
						Posted by <a href="#!">Start Bootstrap</a> on August 24, 2022
					</p>
				</div>
				<!-- Divider-->
				<hr class="my-4" />
				...
				<div class="post-preview">
					...
					<p class="post-meta">
						Posted by <a href="#!">Start Bootstrap</a> on July 8, 2022
					</p>
				</div>
				<!-- Divider-->
				<hr class="my-4" />
				...
				<div class="d-flex justify-content-end mb-4">
					<a class="btn btn-primary text-uppercase" href="#!">Older Posts ¡æ</a>
				</div>
			</div>
		</div>
	</div>
